...
- Coverage strata are reclassified at each event-year start. Their numerators use the full city population denominator before averaging city results; they are not separate stratum-specific weighted means.
